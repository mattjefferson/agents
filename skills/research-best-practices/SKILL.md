...
1. **Discover Available Skills**:
   - Use Glob to find all SKILL.md files: `~/.claude/skills/**/SKILL.md` and `~/.agents/skills/**/SKILL.md`
   - Also check project-level skills: `.claude/skills/**/SKILL.md` or `.agents/skills/**/SKILL.md`
