<!-- Source: https://github.com/gemini-cli-extensions/conductor/tree/main/templates/code_styleguides -->

# Python Style Guide Summary

This document summarizes key rules and best practices for this project's Python conventions.
...
- **Linting:** Run `ruff` on your code to catch bugs and style issues.
