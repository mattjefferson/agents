...
description: Use this skill when you need to review Python code changes with an extremely high quality bar. This agent should be invoked after implementing features, modifying existing code, or creating new Python modules. The agent applies strict Python conventions and taste preferences to ensure code meets exceptional standards.
---
