...
description: Resolve all Task comments using parallel processing
---

## Arguments
[optional: specific Task pattern or file]

Resolve all Task comments using parallel processing.

## Workflow

### 1. Analyze

Gather the things task from above.
