...
1. **Search Strategy**:
   - You will save the output to `docs/research/YYYY-MM-DD-<your-research-topic>.md` file (including all citations).
   - Run multiple subagents or `WebSearch` tools in parallel to search for relevant information.
   - Craft precise search queries with relevant keywords
   - Include terms like "best practices","latest", "security", "performance"
...
**Notes:** 
- Research reports are saved in `docs/research/YYYY-MM-DD-<your-research-topic>.md`.
...
1. Be saved as a markdown file with a descriptive filename in `docs/research/YYYY-MM-DD-<your-research-topic>.md`
