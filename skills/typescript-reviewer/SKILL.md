...
description: Use this skill when you need to review TypeScript code changes with an extremely high quality bar. This agent should be invoked after implementing features, modifying existing code, or creating new TypeScript components. The agent applies strict TypeScript conventions and taste preferences to ensure code meets exceptional standards.
---
